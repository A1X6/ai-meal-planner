        ...
        <div className="hidden lg:flex flex-col space-y-8 p-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-lg">
              Get personalized meal plans, recipes, and shopping lists tailored
              to your preferences.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Smart recommendations based on your dietary preferences
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Automated shopping lists and meal scheduling
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-white font-semibold">Healthy Living</h3>
                <p className="text-gray-400">
                  Nutritionally balanced meals for your lifestyle
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl border border-purple-500/20">
            <blockquote className="text-gray-300 italic">
              ...
              recommendations and personalized nutrition guidance.&quot;
            </blockquote>
          </div>
        </div>
